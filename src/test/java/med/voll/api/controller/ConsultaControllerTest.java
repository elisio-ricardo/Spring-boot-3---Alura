...
@AutoConfigureJsonTesters //para usar a class jackson
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver o codigo http 400")
    @WithMockUser
    void agendarFalha() throws Exception {
    ...
    @DisplayName("Deveria devolver o codigo http 400")
    @WithMockUser
    void agendarSucesso() throws Exception {
